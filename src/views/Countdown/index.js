...
class Countdown extends Component {
    ...
    render() {
        return (
            <div className="live-page countdown d-flex container m-0 justify-content-center flex-column align-items-center">
                <div className="row">
                ...
                <div class="countdown__row row">
                    ...
                    <div className="countdown__copy text-center mt-5 col">
